...
class Aimbot:
    ...
    def is_target_locked(x, y):
        ...
        threshold = 5
        return True if 960 - threshold <= x <= 540 + threshold and 540 - threshold <= y <= 540 + threshold else False
    ...
    def interpolate_coordinates_from_center(absolute_coordinates, scale):
        diff_x = (absolute_coordinates[0] - 1270) * scale/Aimbot.pixel_increment
